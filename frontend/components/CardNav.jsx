...
const CardNav = ({
  ...
  return (
    <div
      className={`card-nav-container absolute left-1/2 -translate-x-1/2 w-[90%] max-w-3/4 z-99 top-[1.2em] md:top-[2em] ${className}`}
    >
      <nav
        ref={navRef}
        ...
        <div className="card-nav-top absolute inset-x-0 top-0 h-15 flex items-center justify-between p-2 pl-[1.1rem] z-2">
          ...
          {!session && (
            <button
              ...
              style={{ backgroundColor: buttonBgColor, color: buttonTextColor }} onClick={() => { router.push("./login") }}
            >
              Login
            </button>
          )}
